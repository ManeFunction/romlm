...
def print_help():
	...
	print("  -u, --unlicensed [options]   Disable Homebrew and Pirate stuff separation to the different folders.")
	print("                               [options] can be 'h' (separate homebrew only), 'p' (separate pirates only), 'none'.")
	...
	print("  -f, --folders [list]         Define subfolders to sort files into, based on tags.\n")
